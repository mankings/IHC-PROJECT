...
function SelectionOptions(props) {
    return (
            ...
            </option><option>Antigua and Deps
            ...
            </option><option>Congo Democratic Rep
            ...
            </option><option>Ireland Republic
            </option><option>Israel
            </option><option>Italy
            </option><option>Ivory Coast
            ...
            </option><option>Korea North
            </option><option>Korea South
            ...
            </option><option>St Kitts and Nevis
            </option><option>St Lucia
            </option><option>Saint Vincent and the Grenadines
            </option><option>Samoa
            </option><option>San Marino
            </option><option>Sao Tome e Principe
